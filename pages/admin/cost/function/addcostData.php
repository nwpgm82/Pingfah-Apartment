...
if($_SESSION['level'] == 'admin'){
  ...
  if ($result->num_rows > 0) {
    ...
    $sql = "INSERT INTO cost (room_id, room_type, cost_status, date, room_cost, water_bill, elec_bill, cable_charge, total) VALUES ('$room_id', '$room_type', 'ยังไม่ได้ชำระเงิน', '$date', '$room_price', '$water_price', '$elec_price', '$cable_price', '$total_price')";
