...
if($_SESSION["level"] == "admin" || $_SESSION["level"] == "employee"){
    ...
    $sql3 = "INSERT INTO dailycost (dailycost_id, room_id, name_title, firstname, lastname, id_card, email, tel, check_in, check_out, damages, total_price, pay_status, code) VALUES ($id, '".$result["room_select"]."', '".$result["name_title"]."', '".$result["firstname"]."', '".$result["lastname"]."', '".$result["id_card"]."', '".$result["email"]."', '".$result["tel"]."', '".$result["check_in"]."', '".$result["check_out"]."', $damages, $total_price, 'ชำระเงินแล้ว', '".$result["code"]."')";
